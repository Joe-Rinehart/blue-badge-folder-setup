        ...
        <Container className="main">
            <Row>
                <Col xs= "12">
                    ...
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, functional components can now both render and display to the page and update the information to be shown/</dd>
...
const HelloWorld = function () {
    return (
        <div>
            <Card>
            <img width = "100%" height = "280ps" src = "https://i.ytimg.com/vi/BwAakF_VUV8/maxresdefault.jpg" alt = "Card cap" />
                <CardBody>
